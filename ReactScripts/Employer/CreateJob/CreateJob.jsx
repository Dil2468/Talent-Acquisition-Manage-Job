...
export default class CreateJob extends React.Component {
    ...
    loadData() {
        ...
        if (param != "" || copyJobParam != "") {
            var link = param != "" ? 'https://talentservice-talent.azurewebsites.net/listing/listing/GetJobByToEdit?id=' + param
                : 'https://talentservice-talent.azurewebsites.net/listing/listing/GetJobForCopy?id=' + copyJobParam;
    ...
    addUpdateJob() {
        ...
        $.ajax({
            ...
            url: 'https://talentservice-talent.azurewebsites.net/listing/listing/createUpdateJob',
    ...
    render() {
       console.log(this.state.jobData.status)
