...
export default class EmployeeProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
           /* http://localhost:60290*/
            url: 'https://talentprofileweb.azurewebsites.net/profile/profile/getEmployerProfile',
            headers: {
    ...
    saveData() {
        ...
        $.ajax({
            /*http://localhost:60290*/
            url: 'https://talentprofileweb.azurewebsites.net/profile/profile/saveEmployerProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
