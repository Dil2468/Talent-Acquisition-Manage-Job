...
export default class AccountProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            ...
            url: 'https://talentprofileweb.azurewebsites.net/profile/profile/getTalentProfile',
            headers: {
    ...
    saveProfile() {
        ...
        $.ajax({
            // http://localhost:60290
            url: 'https://talentprofileweb.azurewebsites.net/profile/profile/updateTalentProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
